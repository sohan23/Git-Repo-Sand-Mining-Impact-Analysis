...
Export.image.toDrive({
    image: bands_1,
    description: 'composite_monsoon_2000',
...
Export.image.toDrive({
    image: bands_2,
    description: 'composite_monsoon_2001',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_3,
    description: 'composite_monsoon_2002',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_4,
    description: 'composite_monsoon_2003',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_5,
    description: 'composite_monsoon_2004',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_6,
    description: 'composite_monsoon_2005',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_7,
    description: 'composite_monsoon_2006',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_8,
    description: 'composite_monsoon_2007',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_9,
    description: 'composite_monsoon_2008',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_10,
    description: 'composite_monsoon_2009',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_11,
    description: 'composite_monsoon_2010',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_12,
    description: 'composite_monsoon_2011',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_13,
    description: 'composite_monsoon_2012',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
Export.image.toDrive({
    image: bands_14,
    description: 'composite_monsoon_2013',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
//for the year 2014
// Load the image collection.
var dataset_15 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2014-06-01', '2014-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_15,
    description: 'composite_monsoon_2014',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
//for the year 2015
// Load the image collection.
var dataset_16 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2015-06-01', '2015-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_16,
    description: 'composite_monsoon_2015',
    folder: 'GEE_Composite',
    scale: 30,
    region: region
});
...
//for the year 2016
// Load the image collection.
var dataset_17 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2016-06-01', '2016-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_17,
    description: 'composite_monsoon_2016',
    folder: 'GEE_Composite',
    scale:30,
    region: region
});
...
//for the year 2017
// Load the image collection.
var dataset_18 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2017-06-01', '2017-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_18,
    description: 'composite_monsoon_2017',
    folder: 'GEE_Composite',
    scale:30,
    region: region
});
...
//for the year 2018
// Load the image collection.
var dataset_19 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2018-06-01', '2018-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_19,
    description: 'composite_monsoon_2018',
    folder: 'GEE_Composite',
    scale:30,
    region: region
});
...
//for the year 2019
// Load the image collection.
var dataset_20 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2019-06-01', '2019-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_20,
    description: 'composite_monsoon_2019',
    folder: 'GEE_Composite',
    scale:30,
    region: region
});
...
//for the year 2020
// Load the image collection.
var dataset_21 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2020-06-01', '2020-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_21,
    description: 'composite_monsoon_2020',
    folder: 'GEE_Composite',
    scale:30,
    region: region
});
...
//for the year 2021
// Load the image collection.
var dataset_22 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2021-06-01', '2021-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_22,
    description: 'composite_monsoon_2021',
    folder: 'GEE_Composite',
    scale:30,
    region: region
});
...
//for the year 2022
// Load the image collection.
var dataset_23 = ee.ImageCollection('LANDSAT/LC08/C02/T1_L2').filterDate('2022-06-01', '2022-09-30').filterBounds(region);
// Compute the median.
...
Export.image.toDrive({
    image: bands_23,
    description: 'composite_monsoon_2022',
    folder: 'GEE_Composite',
    scale:30,
    region: region
});
