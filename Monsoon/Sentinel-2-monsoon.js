...
Export.image.toDrive({
    image: bands_17,
    description: 'Sentinel-monsoon_2016',
...
Export.image.toDrive({
    image: result17,
    description: 'Sentinel_UC_monsoon_2016',
...
Export.image.toDrive({
    image: bands_18,
    description: 'Sentinel-monsoon_2017',
    folder: 'GEE_Composite',
    scale: 10,
    region: region
});
...
Export.image.toDrive({
    image: result18,
    description: 'Sentinel_UC_monsoon_2017',
    folder: 'GEE_Unsupervised',
    scale: 10,
    region: region,
});
...
Export.image.toDrive({
    image: bands_19,
    description: 'Sentinel-monsoon_2018',
    folder: 'GEE_Composite',
    scale: 10,
    region: region
});
...
Export.image.toDrive({
    image: result19,
    description: 'Sentinel_UC_monsoon_2018',
    folder: 'GEE_Unsupervised',
    scale: 10,
    region: region,
});
...
Export.image.toDrive({
    image: bands_20,
    description: 'Sentinel-monsoon_2019',
    folder: 'GEE_Composite',
    scale: 10,
    region: region
});
...
Export.image.toDrive({
    image: result20,
    description: 'Sentinel_UC_monsoon_2019',
    folder: 'GEE_Unsupervised',
    scale: 10,
    region: region,
});
...
Export.image.toDrive({
    image: bands_21,
    description: 'Sentinel-monsoon_2020',
    folder: 'GEE_Composite',
    scale: 10,
    region: region
});
...
Export.image.toDrive({
    image: result21,
    description: 'Sentinel_UC_monsoon_2020',
    folder: 'GEE_Unsupervised',
    scale: 10,
    region: region,
});
...
Export.image.toDrive({
    image: bands_22,
    description: 'Sentinel-monsoon_2021',
    folder: 'GEE_Composite',
    scale: 10,
    region: region
});
...
Export.image.toDrive({
    image: result22,
    description: 'Sentinel_UC_monsoon_2021',
    folder: 'GEE_Unsupervised',
    scale: 10,
    region: region,
});
...
Export.image.toDrive({
    image: bands_23,
    description: 'Sentinel-monsoon_2022',
    folder: 'GEE_Composite',
    scale: 10,
    region: region
});
...
Export.image.toDrive({
    image: result23,
    description: 'Sentinel_UC_monsoon_2022',
    folder: 'GEE_Unsupervised',
    scale: 10,
    region: region,
});
